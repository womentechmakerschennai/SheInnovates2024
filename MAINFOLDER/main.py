    ...
    if st.session_state.curr_page == "Audio":        
        ...
        if st.session_state.video_input is not None:
            ...
            if selected_language and clicked:
                ...
                if clicked:
                    ...
                    videotoaudioinput = st.session_state.video_input
                    textfromextractedaudioofvideo = audiototext.audiototext(videotoaudioinput, lang_code)
                    labela, scorea = textclassifier.textclassifier(textfromextractedaudioofvideo)
                    ...
                    st.text_area(label="Text extracted from video's audio:", value = textfromextractedaudioofvideo, key = "audio_extracted_area", disabled=True)
        ...
        if st.session_state.url_input is not None and st.session_state.url_input != "":
            if clicked:
                ...
                text_from_image = text_from_video.extract_text_from_images(image_files)
